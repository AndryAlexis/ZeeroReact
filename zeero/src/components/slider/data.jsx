...
const data = [
        ...
        source : [
            {
                ...
                srcSet : `${building0_640x1000px}`,
                size : '640w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 768px)',
                srcSet : `${building0_768x1200px}`,
                size : '768w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1024px)',
                srcSet : `${building0_1024x1200px}`,
                size : '1024w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1280px)',
                srcSet : `${building0_1280x1200px}`,
                size : '1280w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1536px)',
                srcSet : `${building0_1536x1200px}`,
                size : '1536w',
                type : 'image/webp'
            },
            {
                media : '(min-width: 1537px)',
                srcSet : `${building0_1980x1000px}`,
                size : '1980w',
                type : 'image/webp'
            },
        ],
    ...
    },
    {
        source : [
            {
                media : '(max-width: 640px)',
                srcSet : `${building1_640x1000px}`,
                size : '640w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 768px)',
                srcSet : `${building1_768x1200px}`,
                size : '768w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1024px)',
                srcSet : `${building1_1024x1200px}`,
                size : '1024w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1280px)',
                srcSet : `${building1_1280x1200px}`,
                size : '1280w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1536px)',
                srcSet : `${building1_1536x1200px}`,
                size : '1536w',
                type : 'image/webp'
            },
            {
                media : '(min-width: 1537px)',
                srcSet : `${building1_1980x1000px}`,
                size : '1980w',
                type : 'image/webp'
            },
        ],
    ...
    },
    {
        source : [
            {
                media : '(max-width: 640px)',
                srcSet : `${building2_640x1000px}`,
                size : '640w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 768px)',
                srcSet : `${building2_768x1200px}`,
                size : '768w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1024px)',
                srcSet : `${building2_1024x1200px}`,
                size : '1024w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1280px)',
                srcSet : `${building2_1280x1200px}`,
                size : '1280w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1536px)',
                srcSet : `${building2_1536x1200px}`,
                size : '1536w',
                type : 'image/webp'
            },
            {
                media : '(min-width: 1537px)',
                srcSet : `${building2_1980x1000px}`,
                size : '1980w',
                type : 'image/webp'
            },
        ],
    ...
    },
    {
        source : [
            {
                media : '(max-width: 640px)',
                srcSet : `${building3_640x1000px}`,
                size : '640w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 768px)',
                srcSet : `${building3_768x1200px}`,
                size : '768w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1024px)',
                srcSet : `${building3_1024x1200px}`,
                size : '1024w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1280px)',
                srcSet : `${building3_1280x1200px}`,
                size : '1280w',
                type : 'image/webp'
            },
            {
                media : '(max-width: 1536px)',
                srcSet : `${building3_1536x1200px}`,
                size : '1536w',
                type : 'image/webp'
            },
            {
                media : '(min-width: 1537px)',
                srcSet : `${building3_1980x1000px}`,
                size : '1980w',
                type : 'image/webp'
            },
        ],
